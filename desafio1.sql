...
CREATE TABLE SpotifyClone.seguindo_artista(
	-- seguindo_artista_id INT AUTO_INCREMENT PRIMARY KEY,
    artista_id INT NOT NULL,
...
CREATE TABLE SpotifyClone.data_reproducao(
--    data_reproducao_id INT AUTO_INCREMENT PRIMARY KEY,
...
INSERT INTO SpotifyClone.musica(titulo,duracao_segundos,album_id)
VALUES
('Soul For Us',200,1),
...
INSERT INTO SpotifyClone.data_reproducao(data_reproducao,usuario_id,musica_id)
VALUES
